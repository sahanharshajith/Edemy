    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
       ...
       md:gap-32 py-10 border-b border-white/30'>
          <div className='flex flex-col md:items-start items-center w-full'>
            ...
            <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem Ipsum is 
          ...
          <div className='hidden md:flex flex-col item-start w-full'>
            ...
            <div className='flex item-center gap-2 pt-4'>
              ...
              <button className='w-24 h-9 rounded text-white bg-blue-600 cursor-pointer'>Subscribe</button>
            </div>
          </div>
       </div>

       <hr />
       <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © Edemy. 
