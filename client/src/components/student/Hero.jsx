...
const Hero = () => {
  return (
    ...
    md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
        ...
        <h1 className='md:text-home-heading-large text-[48px] relative
        font-bold text-gray-800 max-w-3xl mx-auto'>Empower your future with the 
        courses designed to <span className='text-blue-600'>fit your choice.</span><img src={sktech} 
        alt="sktech" className='md:block hidden absolute -bottom-7 right-0'/></h1>
